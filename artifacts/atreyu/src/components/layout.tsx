...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div style={{
      ...
      padding: "20px 12px", boxSizing: "border-box", overflow: "hidden",
    }}>
      ...
      >
        ...
        <div style={{
          ...
          {/* Minimized state — neumorphic expand button centered in the thin strip */}
          {botMinimized && (
            <div style={{
              position: "absolute", bottom: 0, left: 0, right: 0,
              height: BOT_BAR_H,
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.opacity = "1"; e.currentTarget.style.boxShadow = insetSm; }}
                onMouseLeave={e => { e.currentTarget.style.opacity = "0.55"; e.currentTarget.style.boxShadow = raisedSm; }}
              >
