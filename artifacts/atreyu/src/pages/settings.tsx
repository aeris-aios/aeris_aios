    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        <div className="md:col-span-3 space-y-2">
          <Button variant="ghost" className="w-full justify-start bg-muted text-white">
        ...
        <div className="md:col-span-9 space-y-6">
          <Card className="rounded-2xl border border-border bg-card">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input defaultValue="Acme Corp Marketing" className="bg-muted/60 border-border" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-white">Email Address</label>
                <Input defaultValue="admin@acmecorp.com" disabled className="bg-muted/60 border-border opacity-50" />
              </div>
          ...
          <Card className="rounded-2xl border border-border bg-card">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between border border-border bg-muted/60 p-4 rounded-xl">
          ...
          <Card className="glass-panel border-primary/20 bg-primary/5 shadow-[0_0_30px_rgba(0,150,255,0.05)]">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Button variant="outline" className="bg-transparent border-border mt-4">Manage Subscription</Button>
              </div>
            </CardContent>
          </Card>
        </div>
